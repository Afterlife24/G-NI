    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center">
        ...
        <img
          ...
          src={yourImage}
          alt="Preloader Logo"
          className="mb-4 md:mb-0 md:mr-4 h-16 sm:h-20 md:h-25 lg:h-80 object-contain"
          style={{
            willChange: 'transform, opacity',
          }}
        />
        
        <div className="flex items-center justify-center text-4xl sm:text-5xl md:text-8xl lg:text-9xl font-bold">
          <span 
            ref={letterGRef}
            className="inline-block"
            style={{ 
