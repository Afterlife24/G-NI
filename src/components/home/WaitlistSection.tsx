  ...
  <div className="bg-white text-gray-800 p-4 rounded-lg max-w-md"> 
    ...
    <div className="prose prose-xs mb-4 max-h-[60vh] overflow-y-auto"> 
      ...
      <ul className="list-disc pl-5 text-[13px] space-y-1"> 
        ...
        <li>Our full <a href="https://www.gniapp.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">privacy policy</a> can be found on our website</li>
      </ul>
    </div>
